...
function initialize() {
    ...
    // ISLANDS LAYOUT
    add({ tags: ['physics'], physics: new BoundingBox(0+800, 440, 0, 0, 300, 100) });
    add({ tags: ['physics'], physics: new BoundingBox(400+800, 440, 0, 0, 300, 100) });
    add({ tags: ['physics'], physics: new BoundingBox(100+800, 140, 0, 0, 100, 200) });
    add({ tags: ['physics'], physics: new BoundingBox(500+800, 140, 0, 0, 100, 300) });

    // NOOK LAYOUT
    add({ tags: ['physics'], physics: new BoundingBox(0+1600, 440, 0, 0, 800, 100) });
    add({ tags: ['physics'], physics: new BoundingBox(350+1600, 100, 0, 0, 100, 340) });
    add({ tags: ['physics'], physics: new BoundingBox(0+1600, 100, 0, 0, 350, 100) });
