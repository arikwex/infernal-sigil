...
function SERIALIZE(V) {
    const wallType = ({
        [0x000000]: [0, 0],
        [0xffffff]: ["['#a99', '#433', 50, 10, 40, 90, 20, 10, [0, 0, 0, 1, 3], 0]", 0],
        [0x64ff64]: ["['#474', '#242', 20, 30, 10, 10, 50, 40, [2, 2, 2, 0], 1]", 0],
        [0xff80ff]: ["['#b5c', '#535', 70, 70, 40, 20, 10, 20, [1, 1, 1, 3, 0], 2]", 0],
        [0xff800a]: ["['#b72', '#741', 10, 20, 70, 70, 50, 30, [3, 3, 1, 2, 0], 3]", 0],
        [0xc8c800]: ["['#fc1', '#a71', 90, 90, 30, 10, 10, 0, [0], 4]", 0],
    })[V];
    if (wallType) return wallType;
